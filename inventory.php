    ...
    ?>
      ...
      <div class="row-fluid">
        <div class="span12">
          ...
          <div class="row-fluid">
            <div class="span8">
              <h2>Inventario <a href="#" id="reload-inventory"><i class="icon icon-refresh ani">&nbsp;</i></a></h2>
              <table id="inventory-table">
				<tr><td class="slot-103"></td></tr>
				<tr><td class="slot-102"></td></tr>
				<tr><td class="slot-101"></td></tr>
				<tr><td class="slot-100"></td></tr>
				<tr>
					<td class="slot-9"></td>
					<td class="slot-10"></td>
					<td class="slot-11"></td>
            ...
            <div class="span4 fade">
              <h2>Details</h2>
				<table class="table" id="slot-detail">
					<tr><th>Nombre</th><td class="name">0</td></tr>
					<tr><th>ID</th><td class="id">0</td></tr>
					<tr><th>Data</th><td class="data">0</td></tr>
					<tr><th>Da&#241o</th><td class="damage">0</td></tr>
					<tr><th>Cantidad</th><td class="count">0</td></tr>
				</table>
          ...
          <div class="row-fluid">
            <div class="span8">
              <h2>Pendientes <a href="#" id="reload-pendings"><i class="icon icon-refresh">&nbsp;</i></a></h2>
